...
namespace CommandLine.Tests.Unit.Text
{
    public class HelpTextAutoBuildFixWithTypeConverters
    {
        ...
        public void HelpText_with_AdditionalNewLineAfterOption_true_should_have_newline()
        {
            // Fixture setup
            // Exercize system 
            var sut = new HelpText { AdditionalNewLineAfterOption = true, UseAppDomainTypeConverters = true}
        ...
        public void HelpText_with_AdditionalNewLineAfterOption_false_should_not_have_newline()
        {
            // Fixture setup
            // Exercize system 
            var sut = new HelpText { AdditionalNewLineAfterOption = false, UseAppDomainTypeConverters = true}
                .AddOptions(new NotParsed<Simple_Options>(TypeInfo.Create(typeof(Simple_Options)),
                    Enumerable.Empty<Error>()));
        ...
        public void HelpText_with_by_default_should_include_help_version_option()
        {
            // Fixture setup
            // Exercize system 
            var sut = new HelpText (){UseAppDomainTypeConverters = true}
                .AddOptions(new NotParsed<Simple_Options>(TypeInfo.Create(typeof(Simple_Options)),
                    Enumerable.Empty<Error>()));
        ...
        public void HelpText_with_AutoHelp_false_should_hide_help_option()
        {
            // Fixture setup
            // Exercize system 
            var sut = new HelpText { AutoHelp = false,AutoVersion = false, UseAppDomainTypeConverters = true}
                .AddOptions(new NotParsed<Simple_Options>(TypeInfo.Create(typeof(Simple_Options)),
                    Enumerable.Empty<Error>()));
