...
{
    public class HelpTextTestsWithTypeConverters : IDisposable
    {
        ...
        public void Create_instance_without_options(bool newlineBetweenSections)
        {
            ...
            // Exercize system 
            var sut =
                new HelpText(new HeadingInfo("Unit-tests", "2.0"), new CopyrightInfo(true, "Author", 2005, 2013)){UseAppDomainTypeConverters = true};
        ...
        public void Create_instance_with_options(bool newlineBetweenSections)
        {
            // Fixture setup
            // Exercize system 
            var sut = new HelpText { AddDashesToOption = true, AddNewLineBetweenHelpSections = newlineBetweenSections, UseAppDomainTypeConverters = true}
        ...
        public void Create_instance_with_enum_options_enabled()
        {
            // Fixture setup
            // Exercize system 
            var sut = new HelpText { AddDashesToOption = true, AddEnumValuesToHelpText = true, MaximumDisplayWidth = 80, UseAppDomainTypeConverters = true}
                .AddPreOptionsLine("pre-options")
        ...
        public void Create_instance_with_enum_options_disabled()
        {
            // Fixture setup
            // Exercize system 
            var sut = new HelpText { AddDashesToOption = true, UseAppDomainTypeConverters = true}
                .AddPreOptionsLine("pre-options")
                .AddOptions(new NotParsed<Options_With_Enum_Having_HelpText>(TypeInfo.Create(typeof(Options_With_Enum_Having_HelpText)), Enumerable.Empty<Error>()))
                .AddPostOptionsLine("post-options");
        ...
        public void When_defined_MetaValue_should_be_rendered()
        {
            ...
            // Exercize system 
            var sut =
                new HelpText("Meta Value."){UseAppDomainTypeConverters = true}.AddOptions(
        ...
        public void When_help_text_is_longer_than_width_it_will_wrap_around_as_if_in_a_column_given_width_of_40()
        {
            // Fixture setup
            // Exercize system 
            var sut = new HelpText(headingInfo){UseAppDomainTypeConverters = true};
        ...
        public void When_help_text_is_longer_than_width_it_will_wrap_around_as_if_in_a_column_given_width_of_100()
        {
            // Fixture setup
            // Exercize system 
            var sut = new HelpText(headingInfo) { MaximumDisplayWidth = 100, UseAppDomainTypeConverters = true};
            sut.AddOptions(
                new NotParsed<Simple_Options_With_HelpText_Set_To_Long_Description>(
                    TypeInfo.Create(typeof(Simple_Options_With_HelpText_Set_To_Long_Description)),
                    Enumerable.Empty<Error>()));
        ...
        public void Long_pre_and_post_lines_without_spaces()
        {
            // Fixture setup
            // Exercize system 
            var sut = new HelpText("Heading Info."){UseAppDomainTypeConverters = true};
            sut.MaximumDisplayWidth = 40;
        ...
        public void Invoke_AutoBuild_for_Options_returns_appropriate_formatted_text()
        {
            ...
            // Exercize system
            var helpText = HelpText.AutoBuild(fakeResult, useAppDomainTypeConverters:true);
        ...
        public void Invoke_AutoBuild_for_Verbs_with_specific_verb_returns_appropriate_formatted_text_given_display_width_100()
        {
            ...
            // Exercize system
            var helpText = HelpText.AutoBuild(fakeResult, maxDisplayWidth: 100, useAppDomainTypeConverters:true);
        ...
        public void Create_instance_with_options_and_values()
        {
            // Fixture setup
            // Exercize system 
            var sut = new HelpText { AddDashesToOption = true, AdditionalNewLineAfterOption = false, UseAppDomainTypeConverters = true}
                .AddPreOptionsLine("pre-options")
        ...
        public void AutoBuild_when_no_assembly_attributes()
        {
            ...
            HelpText actualResult = HelpText.AutoBuild(fakeResult, ht => ht, ex => ex, useAppDomainTypeConverters:true);
        ...
        public void HelpTextPreservesIndentationAcrossWordWrap()
        {
            // Fixture setup
            // Exercise system 
            var sut = new HelpText { AddDashesToOption = true, MaximumDisplayWidth = 60, UseAppDomainTypeConverters = true}
        ...
        public void HelpTextPreservesIndentationAcrossWordWrapWithSmallMaximumDisplayWidth()
        {
            // Fixture setup
            // Exercise system 
            var sut = new HelpText { AddDashesToOption = true, MaximumDisplayWidth = 10, UseAppDomainTypeConverters = true}
                .AddOptions(new NotParsed<Simple_Options>(TypeInfo.Create(typeof(HelpTextWithLineBreaksAndSubIndentation_Options)),
                    Enumerable.Empty<Error>()));
        ...
        [Fact]
        [Trait("Category", "TypeConverters.CustomHelp")]
        ...
        public void AutoBuild_with_custom_help_and_version_request()
        {
            ...
            HelpText helpText = HelpText.AutoBuild(fakeResult, ht => ht, useAppDomainTypeConverters:true);
        ...
        public void Invoke_AutoBuild_for_Options_with_custom_help_returns_appropriate_formatted_text()
        {
            ...
            // Exercize system
            var helpText = HelpText.AutoBuild(fakeResult, h => h, useAppDomainTypeConverters: true);
